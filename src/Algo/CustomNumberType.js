...
// Imagine that you have a custom Array<digit> type in your app that manage numbers as an array of digits ([0-9] range). Some examples:
// number 	Array
// 123 	[1,2,3]
// 99 	[9,9]
...
console.log(incrementArray([8, 9, 9]));
